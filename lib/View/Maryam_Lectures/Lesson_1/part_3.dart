...
import 'package:quran/View/Maryam_Lectures/Lesson_1/part_4.dart';
import 'package:quran/View/Maryam_Lectures/maryam_contents.dart';

class Lesson1Part3 extends StatefulWidget {
  @override
  _Lesson1Part3State createState() => _Lesson1Part3State();
}

class _Lesson1Part3State extends State<Lesson1Part3> {
  FlutterTts flutterTts = FlutterTts();
  bool a1 = false;
  bool a2 = false;
  bool a3 = false;
  String verse = ''; // Store Quran verse here
  final List<String> chipWords1 = ['and,', "her lord's", 'and'];
  ...
  Future<void> fetchQuranVerse() async {
    setState(() {
      verse = "وَ صَدَّقَتْ بِكَلِمَاتِ رَبِّهَا وَ كُتُبِهِ";
    });
  }
          ...
          child: Column(
            ...
            children: [
              ...
              completeButton == true
                  ? GestureDetector(
                      onTap: () {
                        pushReplacement(context, Lesson1Part4());
                      },
                      child: Container(
                        height: 50,
                        width: MediaQuery.of(context).size.width,
  ...
  TextSpan createHighlightedText() {
    ...
    for (int i = 0; i < words.length; i++) {
      ...
      currentHighlightedIndex == 0 && i == 0 ? isHighlighted = true : false;
      currentHighlightedIndex == 1 && i == 3 ? isHighlighted = true : false;
      currentHighlightedIndex == 2 && i == 4 ? isHighlighted = true : false;
      print("knlnfekfnef$isHighlighted");
      spans.add(TextSpan(
        text: '${words[i]} ',
        style: TextStyle(
          fontSize: 25.0,
  ...
  void highlightNextWord() {
    setState(() {
      print("nekfkrnk$currentHighlightedIndex");
