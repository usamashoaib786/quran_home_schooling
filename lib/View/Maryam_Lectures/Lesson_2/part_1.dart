...
import 'package:quran/View/Maryam_Lectures/Lesson_2/part_2.dart';
import 'package:quran/View/Maryam_Lectures/maryam_contents.dart';
import 'package:percent_indicator/percent_indicator.dart';

class Lesson2Part1 extends StatefulWidget {
  @override
  _Lesson2Part1State createState() => _Lesson2Part1State();
}

class _Lesson2Part1State extends State<Lesson2Part1> {
  FlutterTts flutterTts = FlutterTts();
  bool a1 = false;
  bool a2 = false;
  bool a3 = false;
  String verse = ''; // Store Quran verse here
  final List<String> chipWords1 = ['when', 'said', 'Imran'];
  ...
  Future<void> fetchQuranVerse() async {
    setState(() {
      verse = " إِذْ قَالَتِ امْرَأَتُ عِمْرَانَ";
    });
  }
          ...
          child: Column(
            ...
            children: [
              ...
              completeButton == true
                  ? GestureDetector(
                      onTap: () {
                        pushReplacement(context, Lesson2Part2());
                      },
                      child: Container(
                        height: 50,
                        width: MediaQuery.of(context).size.width,
