...
import 'package:quran/View/Maryam_Lectures/Lesson_2/part_4.dart';
import 'package:quran/View/Maryam_Lectures/maryam_contents.dart';

class Lesson2Part3 extends StatefulWidget {
  @override
  _Lesson2Part3State createState() => _Lesson2Part3State();
}

class _Lesson2Part3State extends State<Lesson2Part3> {
  FlutterTts flutterTts = FlutterTts();
  bool a1 = false;
  bool a2 = false;
  bool a3 = false;
  String verse = ''; // Store Quran verse here
  final List<String> chipWords1 = ['AllKnowing'];
  ...
  Future<void> fetchQuranVerse() async {
    setState(() {
      verse = "ِإِنَّكَ أَنتَ السَّمِيعُ الْعَلِيمُ";
    });
  }
          ...
          child: Column(
            ...
            children: [
                  ...
                  child: Padding(
                    ...
                    child: SizedBox(
                        ...
                        child: txt(
                            containerText:
                                a1 == false
                                    ? "Cerainly, you are All Hearing, the"
                                    : "AllKnowing"
                                      )),
                  ),
                ),
              ...
              completeButton == true
                  ? GestureDetector(
                      onTap: () {
                        pushReplacement(context, Lesson2Part4());
                      },
                      child: Container(
                        height: 50,
                        width: MediaQuery.of(context).size.width,
