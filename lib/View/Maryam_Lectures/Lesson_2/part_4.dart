...
import 'package:quran/View/Maryam_Lectures/Lesson_2/part_5.dart';
import 'package:quran/View/Maryam_Lectures/maryam_contents.dart';

class Lesson2Part4 extends StatefulWidget {
  @override
  _Lesson2Part4State createState() => _Lesson2Part4State();
}

class _Lesson2Part4State extends State<Lesson2Part4> {
  FlutterTts flutterTts = FlutterTts();
  bool a1 = false;
  bool a2 = false;
  bool a3 = false;
  String verse = ''; // Store Quran verse here
  final List<String> chipWords1 = ['said,', 'MyLord,', 'Certainly,I'];
...
// Updated to store the accumulated text
  ...
  Future<void> fetchQuranVerse() async {
    setState(() {
      verse = "فَلَمَّا وَضَعَتْهَا قَالَتْ رَبِّ إِنِّي وَضَعْتُهَا أُنثَى";
    });
  }
          ...
          child: Column(
            ...
            children: [
                    ...
                    child: SizedBox(
                        ...
                        child: txt(
                            containerText: a1 == false &&
                                    a2 == false &&
                                    a3 == false
                                ? "But when she gave birth, she"
                                : a1 == true
                                    ? 'said, "'
                                    : a2 == true
                                        ? " MyLord, "
                                        : "Certainly,I have given birth to a girl")),
                  ),
                ),
              ),
              const SizedBox(
              ...
              completeButton == true
                  ? GestureDetector(
                    onTap: () {
                      pushReplacement(context, Lesson2Part5());
                    },
                    child: Container(
                        height: 50,
                        width: MediaQuery.of(context).size.width,
